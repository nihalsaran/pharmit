...
import 'package:pharmit/screens/admin_signup.dart';
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          leading: GestureDetector(
            ...
            //   context,
            //   MaterialPageRoute(builder: (context) => const Login()),                        // UN COMMENT PLEASE
            // ),
          ),
          centerTitle: true,
          elevation: 0.0,
                          ...
                          TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () {
                                  // Navigator.push(
                                  //   context,
                                  //   MaterialPageRoute(                           // UN COMMENT PLEASE  
                                  //       builder: (context) =>
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const Register()),                     // UN COMMENT PLEASE
                                );
                              }),
                      ],
                    ),
  ...
  signIn() async {
    if (email.text.isEmpty || pin.text.isEmpty) {
      ...
      try {
        ...
        //         context,
        //         MaterialPageRoute(builder: (context) => const AdminDashboard()),                   // UN COMMENT PLEASE
